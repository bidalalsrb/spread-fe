  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>결석 내용을 입력하고 저장하세요.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            maxLength={2000}
            placeholder="결석 내용 입력"
          />
        </div>

        <Button className="w-full" type="button" onClick={handleSave} disabled={loading || students.length === 0}>
          {loading ? '저장 중...' : '결석 저장'}
        </Button>
